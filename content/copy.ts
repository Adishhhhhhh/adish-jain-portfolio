...
export const SITE = {
  ...
  advertiserHandle: "Creative Strategist · Mumbai",
  honestLine:
...
export const SCREEN_3 = {
  honestLine:
    "No spend to show. These never ran. Here is what a real ad account never would: the entire reasoning.",
  aboutAdvertiserHeading: "About Adish",
  approachLink: "How I think",
};
